Spree::Core::Engine.routes.draw do
  match '/admin/reports/outstanding' => 'admin/reports#outstanding', via: [:get, :post], as: 'outstanding_admin_reports'
  ...
  match '/admin/reports/profit'      => 'admin/reports#profit',      via: [:get, :post], as: 'profit_admin_reports'
  ...
  match '/admin/reports/geo_sales'    => 'admin/reports#geo_sales',    via: [:get, :post], as: 'geo_sales_admin_reports'
  match '/admin/reports/transactions' => 'admin/reports#transactions', via: [:get, :post], as: 'transactions_admin_reports'
